...
exception bad_arg_count(int n_given, int n_min, int n_max)
{
    stringstream ss;
...
exception missing_arg(const char *arg_name)
{
    throw runtime_error("function argument '" + string(arg_name) + "' must be specified");
}
